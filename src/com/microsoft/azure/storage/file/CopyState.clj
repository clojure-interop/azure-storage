(ns com.microsoft.azure.storage.file.CopyState
...
(defn get-status
  ...
  returns: A CopyStatus object representing the status of the copy operation. - `com.microsoft.azure.storage.file.CopyStatus`"
  (^com.microsoft.azure.storage.file.CopyStatus [^CopyState this]
    (-> this (.getStatus))))
