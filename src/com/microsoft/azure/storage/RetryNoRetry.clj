(ns com.microsoft.azure.storage.RetryNoRetry
...
(defn *get-instance
  ...
  returns: A RetryNoRetry object that represents a no retry policy. - `com.microsoft.azure.storage.RetryNoRetry`"
...
(defn create-instance
  ...
  (^com.microsoft.azure.storage.RetryPolicy [^RetryNoRetry this ^com.microsoft.azure.storage.OperationContext op-context]
...
(defn evaluate
  ...
  (^com.microsoft.azure.storage.RetryInfo [^RetryNoRetry this ^com.microsoft.azure.storage.RetryContext retry-context ^com.microsoft.azure.storage.OperationContext operation-context]
